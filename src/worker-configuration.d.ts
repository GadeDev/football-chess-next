/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: bacf0b01d6ee1aa1b8808ffe2a8edecb)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "MatchRoom" | "AccountStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CONTENT_SLUG" | "PUBLIC_BASE_PATH" | "UNIVERSO_FUTBOL_URL" | "PLATFORM_API_ORIGIN">> {}
}
