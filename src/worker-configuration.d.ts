/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 2f960605e2f7b604159ad7ec9c22b658)
...
interface __BaseEnv_Env {
	...
	UNIVERSO_FUTBOL_URL: "https://universo-frontpage-staging.pages.dev" | "https://universo-futbol.com";
	PLATFORM_API_ORIGIN: "https://fc-platform-api-staging.yanagiho.workers.dev" | "https://fc-platform-api.yanagiho.workers.dev";
	ENVIRONMENT: string;
	MATCH_ROOM: DurableObjectNamespace<import("./index").MatchRoom>;
	ACCOUNTS: DurableObjectNamespace<import("./index").AccountStore>;
	MATCHMAKER: DurableObjectNamespace<import("./index").Matchmaker>;
	PLATFORM_API: Fetcher /* fc-platform-api-staging */ | Fetcher /* fc-platform-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "MatchRoom" | "AccountStore" | "Matchmaker";
	}
	interface StagingEnv {
		ASSETS: Fetcher;
		CONTENT_SLUG: "universofutbol-football-chess";
		PUBLIC_BASE_PATH: "/universofutbol/football-chess";
		UNIVERSO_FUTBOL_URL: "https://universo-frontpage-staging.pages.dev";
		PLATFORM_API_ORIGIN: "https://fc-platform-api-staging.yanagiho.workers.dev";
		ENVIRONMENT: string;
		MATCH_ROOM: DurableObjectNamespace<import("./index").MatchRoom>;
		ACCOUNTS: DurableObjectNamespace<import("./index").AccountStore>;
		MATCHMAKER: DurableObjectNamespace<import("./index").Matchmaker>;
		PLATFORM_API: Fetcher /* fc-platform-api-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTENT_SLUG" | "PUBLIC_BASE_PATH" | "UNIVERSO_FUTBOL_URL" | "PLATFORM_API_ORIGIN" | "ENVIRONMENT">> {}
}
